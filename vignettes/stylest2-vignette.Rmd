...
```{r echo = FALSE}
kable(head(predictions$term_influence$features[order(predictions$term_influence$mean_influence, decreasing = TRUE)])) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
```
...
```{r echo = FALSE}
kable(tail(predictions$term_influence$features[order(predictions$term_influence$mean_influence, decreasing = TRUE)])) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
```
